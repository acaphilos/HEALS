        ...
        if (!empty($all_users)) {
            foreach ($all_users as $row) {
                ...
                <tr>
                    ...
                    echo '<form method="post" action="' . base_url('ManageAllUser/updateUserProfile/' . $row->uId) . '" onsubmit="return confirmUpdate(' . $row->uId . ')">
                          <button type="submit" value="Update" class="m-2 btn btn-secondary"><h6 class ="text-white">Update</h6></i></button>
                          </form>';

                    echo '<form method="post" action="' . base_url('RecordUserList/viewUserRecords/' . $row->uId) . '" onsubmit="return confirmUpdate(' . $row->uId . ')">
