      ...
      <?php  
         if (!empty($feedback_data)) {
            foreach ($feedback_data as $row) {  
                ...
                <td>
                    <?php
                    echo '<form method="post" action="' . base_url('AdminFeedback/deleteFeedback/' . $row->feedbackId) . '" onsubmit="return confirmDelete(' . $row->feedbackId . ')">
            ...
            <?php
              ...
              ?>
              <tr>
                <td colspan="7">You have no feedbacks</td>
            </tr>
              <?php
            }
          ?> 
